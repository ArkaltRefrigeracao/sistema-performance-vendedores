...
# --- NOVA ROTA ADICIONADA PARA A RAIZ DO DOMÍNIO ---
@app.route('/')
def root_redirect():
    """
    Redireciona a raiz do domínio para a página de login do Blueprint de performance.
    """
...
# REMOVA OU COMENTE ESTE BLOCO PARA O DEPLOY NO RENDER
